...
public class Api {
    ...
    public List<Coiffeur> getCoiffeurs(){
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/coiffeurs")
                .build();
    ...
    public List<Nouveaute> getNouveautes() {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/nouveautes")
                .build();
    ...
    public List<Coupes> getCoupes(){
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/coupes")
                .build();
    ...
    public List<CoupeCoiffeur> getCoupeCoiffeurs(){
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/coupeCoiffeur")
                .build();
    ...
    public List<Photo> getPhoto(){
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/photos")
                .build();
    ...
    public boolean setClient(Client client) {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/client") // Update if your endpoint is different
    ...
    public List<RendezVous> getRendezVous() {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/rendezvous")
                .build();
    ...
    public boolean annulerRendezVous(int idRendezVous) {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/rendezvous/" + idRendezVous)
                .delete()
                .build();
    ...
    public boolean ajouterAvis(int idRendezVous, String titre, String commentaire, int note) {
        ...
        Request request = new Request.Builder()
                .url("http://192.168.2.21:5000/avis")
                .post(body)
                .build();
